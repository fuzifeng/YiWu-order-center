 ...
 * @author
 * @version 1.0.0
 * @createdAt 2022/8/18 16:19
 * @updatedAt 2022/8/18 16:19
 */
public final class DataMaskingSerializer extends StdScalarSerializer<Object> {

    private DataMaskingOperationInterface operation;
    ...
    public DataMaskingSerializer(DataMaskingOperationInterface operation) {
        super(String.class, false);
